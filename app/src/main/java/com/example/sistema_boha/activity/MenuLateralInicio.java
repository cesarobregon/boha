package com.example.sistema_boha.activity;
...
import com.example.sistema_boha.databinding.ActivityMenuInicioBinding;
...
public class MenuLateralInicio extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.appBarMenuInicio.fab.setOnClickListener(new View.OnClickListener() {
            @Override

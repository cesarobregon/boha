...
public class ComidasCategorias extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_comidas_categorias);
        ...
        if (getSupportActionBar() != null) {
            ...
            getSupportActionBar().setTitle("Categorias de Comidas");
        ...
        RecyclerView recyclerView = findViewById(R.id.recyclerViewCategoriasComidas);
    ...
    // Método para listar las categorias (comidas) desde el servidor
    public void listarCategorias() {
        ...
        String url = "http://"+direccion+"/conexionbd/ListarCategoriasComidas.php";
        ...
        JsonArrayRequest jar = new JsonArrayRequest(Request.Method.GET, url, null,
            ...
            public void onResponse(JSONArray response) {
                ...
                recyclerView.setLayoutManager(new LinearLayoutManager(ComidasCategorias.this));
                // Crear un adaptador (ProductoAdapter) que tomará los datos de respuesta
                // (JSON) y los mostrará en el RecyclerView
                CategoriaAdapter adapter = new CategoriaAdapter(ComidasCategorias.this, response);
